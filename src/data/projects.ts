...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    featured: true,
    image: 'https://opengraph.githubassets.com/1/ByteTheCookies/DiscordCTFHelper',
  },
  {
    id: 'zdiff',
    slug: 'zdiff',
...

  {
    ...
    description: 'A browser extension designed to improve the style, readability, and customization of code comments.',
    detail: [
...

  {
    ...
    approach: 'Implemented service checks and desktop notification behavior to surface availability changes quickly.',
    outcome:
...

  {
    ...
    approach: 'Combined playlist scraping with local media-processing workflows and command-line tooling.',
    outcome:
...

  {
    ...
    description: 'A Python utility for extracting content from Wallpaper Engine Workshop assets.',
    detail: [
    ...
    approach: 'Created a focused extraction utility to process Wallpaper Engine Workshop content.',
    outcome: 'Delivered a practical reverse-engineering-oriented tool for working with desktop application assets.',
    featured: true,
...

  {
    ...
    outcome: 'Created a focused terminal utility combining Rust, API integration, and practical developer ergonomics.',
    featured: true,
...

  {
    ...
    outcome: 'Connected editor extensibility with cybersecurity tooling in a compact open-source project.',
    featured: true,
